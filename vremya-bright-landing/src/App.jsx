    ...
    <section id="top" className="relative overflow-hidden px-5 pb-20 pt-16 sm:px-8 sm:pb-28 sm:pt-24">
      ...
      <div className="relative mx-auto max-w-5xl text-center">
        ...
        <p className="mx-auto mt-7 max-w-2xl text-xl font-extrabold text-white sm:text-2xl">
          За 10 дней мероприятий вы заработаете 1 000 000 чистой прибыли
        </p>
    ...
    <section id="audience" className="relative px-5 py-20 sm:px-8 sm:py-28">
      <div className="mx-auto max-w-6xl">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="text-3xl font-extrabold text-white sm:text-4xl">Для кого этот курс</h2>
...
function Offer() {
  const items = [
    'Вы узнаете, как запускать бизнес с вложениями 0 рублей',
    'Вы приобретёте навык продаж по авторской методике',
    'Вы получите все необходимые документы: чек-листы, пошаговые инструкции, сценарий, календарь',
    'Мы предоставим макеты афиши, флаеров, билетов, финансовой модели',
    'Вы познакомитесь с уникальной программой мероприятия, на которую клиенты возвращаются поколениями',
    'А также мы поделимся, как с одного мероприятия получать 200 новых контактов',
  ]
      ...
      <div className="mx-auto max-w-4xl">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-gray-400">
            15 лет в организации мероприятий и
            <br />
            10 лет проведения уникального авторского продукта, который еще никто не повторил
          </p>
        </div>
  ...
  const blocks = [
    {
      ...
      title: 'Подготовка',
      bullets: [
        'Пошаговый план, как подготовить всё мероприятие без расходов.',
        'Финансовая модель с 40% маржинальностью — рассчитаем вместе.',
        'Как вести переговоры, чтобы получать лучшие условия при взаимовыгодном сотрудничестве.',
        'Вместе разработаем конкурентоспособную ценовую политику для вашей территории.',
